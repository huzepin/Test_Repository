...
public class XTUtils {
	...
	public static void printNote(Resources resources, PrinterInstance mPrinter) {
		...
		mPrinter.printText("酷我小店"+ "\n");
		mPrinter.setPrinter(Command.ALIGN, Command.ALIGN_LEFT);
		// 字号使用默认
		mPrinter.setFont(0, 0, 0, 0, 0);

		sb.append("门店号："+ "574001\n");
		sb.append("单据" + "S00003169\n");
		sb.append("收银员："+ "s004_s004\n");
		sb.append("单据日期：" + "2012-06-17\n");
		...
		sb.append("公司名称：江苏某某家居用品有限公司" + "\n");
		sb.append("公司网址："+ "www.jiangsuxxxx.com\n");
		sb.append("地址：江苏省宁波市某某路某某号" + "\n");
		sb.append("电话：" + "0574-12345678\n");
		sb.append("服务专线："+ "4008-123-456 \n");
