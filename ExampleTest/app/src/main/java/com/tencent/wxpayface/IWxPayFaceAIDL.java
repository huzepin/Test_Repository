...
public static abstract class Stub extends android.os.Binder implements IWxPayFaceAIDL
{
 ...
 */
public static IWxPayFaceAIDL asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof IWxPayFaceAIDL))) {
return ((IWxPayFaceAIDL)iin);
}
...
private static class Proxy implements IWxPayFaceAIDL
{
